...
// Whne Item Starts Dragging
function drag(e){
  draggedItem = e.target;
  console.log('draggedItem',draggedItem)
}

// Column Allows for iitem to drop 
function allowDrop(e){
  e.preventDefault();
}
// When item enters column area
function dragEner(column){
  console.log(listColumns[column].classList.add('over'))
  currentColumn = column;
}
// Droppping item in column
function drop(e){
  e.preventDefault();
